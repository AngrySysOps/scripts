...
# Forces Windows PowerShell 5.1 to ignore untrusted SSL certificates globally for this session
...
Function Get-TlsCertificateSha256Fingerprint {
    ...
    try {
        ...
        # Windows PowerShell 5.1 friendly SHA256 hashing
...
# Removed -SkipCertificateCheck (Handled globally above)
